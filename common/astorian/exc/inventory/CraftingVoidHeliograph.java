...
public class CraftingVoidHeliograph {
	
	private static final CraftingVoidHeliograph instance = new CraftingVoidHeliograph();
	
	private List recipes = new ArrayList();
	
	public static final CraftingVoidHeliograph getInstance()
	{
	         return instance;
	}
	
	private CraftingVoidHeliograph()
	{
	         Collections.sort(this.recipes, new RecipeSorterVoid(this));
	         System.out.println(this.recipes.size() + " Heliograph Recipes");
	}
	
	public void addVoidRecipe(ItemStack itemstack, Object ... inputArray)
	{
	         String var3 = "";
	         int var4 = 0;
	         int var5 = 0;
	...
	public void addShapelessVoidRecipe(ItemStack itemstack, Object ... inputArray)
	{
