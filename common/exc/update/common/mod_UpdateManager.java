...
import exc.update.client.CapeHandler;
import exc.update.client.GuiModListWithUMButton;
import exc.update.client.ModReleaseType;
import exc.update.client.ModType;
import exc.update.client.UMKeyBinding;
import exc.update.common.Settings;
import exc.update.common.ThreadUpdateManager;
import exc.update.common.UpdateManager;
import exc.update.common.UpdateManagerMod;
import exc.update.common.commands.UpdateManagerCommands;
...
public class mod_UpdateManager{
	...
	public void modsLoaded(FMLPostInitializationEvent event) {
		exc.update.common.Settings.init();
	...
	public void load(FMLInitializationEvent event) {
		new exc.update.common.ModCompatibility();
